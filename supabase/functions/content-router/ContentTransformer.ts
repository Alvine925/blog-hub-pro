 ...
 *
 * Transforms raw database rows into clean public API shapes.
 * Strips internal fields (id, workspace_id, user_id, storage_path, etc.)
 * so the database schema is never exposed to API consumers.
 */
